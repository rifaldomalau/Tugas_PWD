...
if(isset($_POST['simpan'])){
	...
	//php7+
	$update = mysqli_query($koneksi, "UPDATE siswa SET siswa_nis='$nis', siswa_nama='$nama', siswa_kelas='$kelas', siswa_jurusan='$jurusan' WHERE siswa_id='$id'") or die(mysqli_error($koneksi));
